 ...
 * @author ASUS
 */
public class HalamanUtamaPeminjam extends javax.swing.JFrame {
...
//    private String nim = "1";
    ...
    private void initComponents() {
        ...
        btnStatusPeminjaman = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jLabel1.setText("Halaman Utama");

        btnStatusPeminjaman.setText("Status Peminjaman");
        btnStatusPeminjaman.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnStatusPeminjamanActionPerformed(evt);
            }
        });
    ...
    public static void main(String args[], UpdateManager updateManager) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HalamanUtamaPeminjam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton btnStatusPeminjaman;
